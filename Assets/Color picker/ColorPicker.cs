...
public class ColorPicker : MonoBehaviour, IPointerDownHandler, IDragHandler, IPointerUpHandler
{
    ...
    {
        color = GameManager.currentHandler.items[0].material.color;
    ...
    private void ApplyColor()
    {
        ...
        foreach (SkinnedMeshRenderer item in GameManager.currentHandler.items)
        {
            item.material.color = color;
        }
        GameManager.currentHandler.graphic.color = color;
    }
